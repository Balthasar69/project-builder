  ...
  if (!dokumenteLink) {
    return darfBearbeiten ? (
      <button
        ...
        className="mb-8 inline-flex w-fit items-center gap-2.5 rounded-md border-2 border-dashed border-accent/50 px-6 py-3.5 text-base font-semibold text-accent transition hover:border-accent hover:bg-accent-soft/40"
      >
        <svg
          width="18"
          height="18"
